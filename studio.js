...
(() => {
  ...
  function refreshTransport(){icon($('#playBtn'),state.playing?'pause':'play');icon(document.querySelector('[data-action="play"]'),state.playing?'pause':'play');icon($('#muteBtn'),$('#muteBtn').textContent==='🔇'?'volume-x':'volume-2')}
