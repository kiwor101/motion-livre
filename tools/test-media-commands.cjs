...
const FrameRate=require('../.build/core/frame-rate.js');
assert.equal(FrameRate.preferredFrameRate('24000/1001','8727000/371371'),23.976);assert.equal(FrameRate.canonicalFrameRate(23.499411639573363),23.976);assert.equal(FrameRate.canonicalFrameRate(26),26);assert.equal(FrameRate.projectFrameRate(23.976),30);assert.equal(FrameRate.projectFrameRate(50),50);
